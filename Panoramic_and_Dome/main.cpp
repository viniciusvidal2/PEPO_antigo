...
{ 
    ...
    //     Load the images
    Mat img_object= imread("/home/grin/B9/Panoramic_and_Dome/Externa/30.JPG",CV_LOAD_IMAGE_COLOR);
    Mat img_scene= imread("/home/grin/B9/Panoramic_and_Dome/Externa/29.JPG" ,CV_LOAD_IMAGE_COLOR);
    Mat gray_image1;
    Mat gray_image2;
    // Convert to Grayscale
        cvtColor( img_scene, gray_image1, CV_RGB2GRAY );
        ...
        cv::Mat result;
        //    warpPerspective(img_scene,result,H,cv::Size(2*img_scene.cols+2*img_object.cols,img_scene.rows));
        warpPerspective(img_scene,result,H,img_object.size(),cv::INTER_LINEAR + cv::WARP_INVERSE_MAP);

        //    cv::Mat half(result,cv::Rect(0,0,img_object.cols,img_object.rows));
        //    img_object.copyTo(half);
        string resul = "/home/grin/B9/Panoramic_and_Dome/Externa/result.JPG";
