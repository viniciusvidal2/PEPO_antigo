...
::PROTOBUF_NAMESPACE_ID::uint8* Imagem_Pixel::InternalSerializeWithCachedSizesToArray(
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_name(), ptr, ctx, "ImagemMsgProto.Imagem.name");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // int32 height = 2;
...
::PROTOBUF_NAMESPACE_ID::uint8* Imagem::InternalSerializeWithCachedSizesToArray(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  ...
  for (unsigned int i = 0,
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(4, this->_internal_pixels(i), target, stream);
  }
